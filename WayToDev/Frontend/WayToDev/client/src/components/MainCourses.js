	...
	const [courses, setCourses] = useState([
		{
			...
			description:
				"JavaRush-це  онлайн курс  навчання програмування на Java, який 80% складається з практики",
			avtor: "JavaRush",
			like: null,
			comment: null,
		},
		...
		},
		{
			...
			description:
				"Навчання основ програмування з нуля онлайн — це раціональний спосіб познайомитися з різними мовами програмування. І в результаті — обрати свій напрямок в IT.\n\n",
			avtor: "ITEA ",
			like: null,
			comment: null,
		},
			...
			<div className="corses">
				<div className="container">
					<div className="courses_header">
						...
						<a href="/" className="courses_btn csbtn">All courses</a>
					</div>

					<div class="video">
						{courses.map((course) => (
							<div class="video_intro" key={course.id}>
								<iframe
									width="100%"
									height="315"
									src="https://www.youtube.com/embed/VDDhOmBW5ZA"
									title={course.name_course}
								></iframe>
								<div class="video_text">
									{course.name_course}
								</div>
								<div class="video_amount">{course.avtor}</div>
							</div>
						))}
					</div>
				</div>
