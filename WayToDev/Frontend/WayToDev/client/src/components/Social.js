        ...
        <div className = "socials">
            <div className = "container">
                ...
                <div className = "social_links">
                    ...
                    <div class="button">
                        <div class="icon">
                        <a href = "https://web.telegram.org/z/"target = "_blank"rel="noreferrer"><i class="fab fa-telegram"></i></a>
                        </div>
                        <a href = "https://web.telegram.org/z/"target = "_blank"rel="noreferrer"><span>Telegram</span></a>
                    </div>
                    <div class="button">
                        <div class="icon">
                        <a href = "https://www.youtube.com/"target = "_blank"rel="noreferrer"><i class="fab fa-youtube"></i></a>
                        </div>
                        <a href = "https://www.youtube.com/"target = "_blank"rel="noreferrer"><span>YouTube</span></a>
                    </div>
                    <div class="button">
                        <div class="icon">
                        <a href = "https://github.com/maryanchuk04"target = "_blank"rel="noreferrer"><i class="fab fa-github"></i></a>
                        </div>
                        <a href = "https://github.com/maryanchuk04"target = "_blank"rel="noreferrer"><span>GitHub</span></a>
                    </div>
                </div>
