					...
					<div class="card">
						<div class="card-body">
							<div class="d-flex flex-column align-items-center text-center">
								<img src="https://api.icons8.com/download/660fc92e39d6c564045636121a69db9c850515ce/windows10/PNG/512/Very_Basic/contacts-512.png" alt="Admin" class="rounded-circle p-1 bg-primary"></img>
								<div class="mt-3">
									<h4>John Doe</h4>	
								</div>
							</div>
							<hr class="my-4"></hr>
							<button class="btn btn-primary">Download the pictures</button>
						</div>
					</div>
				</div>
				<div class="col-lg-8">
